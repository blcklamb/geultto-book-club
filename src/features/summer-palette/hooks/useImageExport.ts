...
export function useImageExport() {
  ...
  async function exportBoard(board: PaletteBoard) {
    setIsExporting(true);
    setError(null);
...
export async function renderBoardToPng(board: PaletteBoard) {
  const canvas = await renderBoardToCanvas(board);
  return canvas.toDataURL("image/png");
}

export async function renderBoardToBlob(board: PaletteBoard) {
  const canvas = await renderBoardToCanvas(board);
...
async function renderBoardToCanvas(board: PaletteBoard) {
